...
class ExpenseSummary extends StatelessWidget {
  ...
  // dynamically increaste the maximum y value of the graph (aka height)
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text('\$${calculateWeeklyTotal(value, sunday, monday, tuesday, wednesday, thursday, friday, saturday)}'),
            ],
          ),
